...
module.exports = function () {
    ...
    // Add a new route handler for getting database information
    router.get('/db-info', setCustomHeader, async (req, res) => {
      try {
        ...
        // Use the admin database to fetch database info
        const adminDb = client.db(clientData.connection.database);
